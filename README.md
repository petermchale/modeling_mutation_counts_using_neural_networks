...
* By fitting the model to germline and somatic variation data, infer genomic regions under natural selection by identifying regions in which the mutation count deviates 
from expectation. In other words, infer variants that give rise to inherited Mendelian diseases and driver mutations in cancer.
