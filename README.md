...
* By fitting the model to germline and somatic variation data, infer genomic regions under natural selection by identifying regions in which the mutation count is lower or higher than expected, i.e. infer variants that give rise to inherited Mendelian diseases, and driver mutations in cancer.
